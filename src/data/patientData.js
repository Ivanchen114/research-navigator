export const patientData = [
  ...
  {
    id: 1,
    primaryDiagnosisKey: "空",
    priorityDiagnosisKey: "空",
    acceptableDiagnosisKeys: [],
    coDiagnosisKeys: [],
    priorityReason: "這題最大問題是「美的本質」太抽象，就算縮小範圍也還是無法直接操作化，所以先救「空」。",
    focusTerms: ["美","本質"],
    focusCue: "「美」和「本質」——這兩個詞有辦法觀察或測量嗎？先判斷這個概念能不能轉成可研究的指標。",
    question: "探究美的本質",
    diagnosis: "抽象哲學病",
    causes: ["空"],
    cures: ["實"],
  ...
  },
  {
    ...
    focusTerms: ["有沒有"],
    focusCue: "先看問法：「有沒有」做完只能回答是或否——研究從這裡能走到哪裡？",
  ...
  {
    id: 3,
    primaryDiagnosisKey: "遠",
    priorityDiagnosisKey: "遠",
    acceptableDiagnosisKeys: [],
    coDiagnosisKeys: [],
    priorityReason: "題目在問尚未發生的未來，現在無法驗證，因此先判算命占卜病。",
    focusTerms: ["2030年"],
    focusCue: "「2030年」的資料現在存在嗎？先判斷這題能不能研究，再想其他問題。",
  ...
  {
    id: 4,
    primaryDiagnosisKey: "大",
    priorityDiagnosisKey: "大",
    acceptableDiagnosisKeys: [],
    coDiagnosisKeys: [],
    priorityReason: "題目範圍大到全球層級，若不先縮小範圍，後面根本無法落地。",
    focusTerms: ["全球暖化","成因與解決方法"],
    focusCue: "這題同時要研究「成因」和「解決方法」，範圍又是全球——先想：這個題目裝了幾個不同的問題？",
  ...
  },
  {
    ...
    focusTerms: ["有沒有","熬夜"],
    focusCue: "先看問法：「有沒有」做完只能回答是或否——你真正想研究的其實是什麼？",
  ...
  },
  {
    ...
    focusTerms: ["有沒有","偷滑手機"],
    focusCue: "先看問法：「有沒有」讓研究停在是非判斷——你真正想了解的是頻率、時段，還是什麼？",
  ...
  {
    id: 7,
    primaryDiagnosisKey: "難",
    priorityDiagnosisKey: "難",
    acceptableDiagnosisKeys: [],
    coDiagnosisKeys: [],
    priorityReason: "「那麼吵」是強烈主觀感受，最大問題是語句先帶情緒與價值判斷，所以先救偏見。",
    focusTerms: ["那麼吵"],
    focusCue: "「那麼吵」是客觀描述，還是主觀感受？先想：這個詞背後藏了什麼立場。",
    question: "為什麼我們班那麼吵？",
    diagnosis: "主觀偏見病",
    causes: ["難"],
    cures: ["易"],
  ...
  },
  {
    ...
    focusTerms: ["都很難吃"],
    focusCue: "「都很難吃」——先想：這是可以測量的指標，還是先下判斷的情緒評語？",
  ...
  },
  {
    ...
    focusTerms: ["是不是","都會"],
    focusCue: "這題有兩個可疑點：「是不是」（問法）和「都會」（誇大預設）。先想：哪個問題讓研究根本做不下去？",
    question: "高中生是不是都會熬夜？",
    diagnosis: "是非廢話病",
    causes: ["空"],
    cures: ["實"],
  ...
  // 🟡 黃卡（進階：通常兩個問題疊加）
  {
    ...
    focusTerms: ["現代人","越來越不快樂"],
    focusCue: "這題有兩個可疑點：「現代人」（範圍）和「不快樂」（概念）。先想：哪個問題更先讓研究找不到起點？",
  ...
  },
  {
    ...
    focusTerms: ["存在的意義"],
    focusCue: "「存在的意義」——這個概念有辦法觀察、測量，或蒐集資料嗎？先判斷這題的核心概念能不能操作化。",
    question: "人類存在的意義是什麼？",
  ...
  },
  {
    ...
    focusTerms: ["比打電動更好"],
    focusCue: "「讀書比打電動更好」——題目在還沒研究之前，就已經先假設了什麼？先找出那個隱藏的前提。",
  ...
  },
  {
    ...
    focusTerms: ["台灣的教育制度","好不好"],
    focusCue: "這題有兩個可疑點：「教育制度」（範圍極大）和「好不好」（主觀判斷）。先想：哪個不先處理，連研究方向都定不下來？",
    question: "台灣的教育制度好不好？",
    diagnosis: "百科全書病 + 主觀偏見病",
    causes: ["大", "難"],
    cures: ["小", "易"],
  ...
  },
  {
    ...
    focusTerms: ["賈伯斯"],
    focusCue: "研究對象是賈伯斯——先想最根本的問題：你有辦法聯繫到他嗎？",
    question: "訪談賈伯斯的創新理念",
  ...
  },
  {
    ...
    focusTerms: ["壓力","特別大"],
    focusCue: "「壓力」是什麼？「特別大」是跟什麼比？先想：這些詞有辦法直接觀察或測量嗎？",
  ...
  },
  {
    ...
    focusTerms: ["社團活動","成效"],
    focusCue: "這題有兩個可疑點：「社團活動」（哪種社團？）和「成效」（怎麼定義？）。先想：哪個問題更先讓研究找不到起點？",
  ...
  // 🔴 紅卡（魔王病歷）
  {
    ...
    focusTerms: ["人生成就","影響"],
    focusCue: "「早餐」和「人生成就」之間會有多少其他因素？先想：如果要研究這題，你能控制多少變項？",
    question: "早餐對人生成就的影響",
  ...
  },
  {
    ...
    focusTerms: ["手機使用","學業成績"],
    focusCue: "「手機使用」涵蓋哪些行為？先想：這個詞裝了多少不同的東西，讓研究找不到起點？",
  ...
  },
  {
    ...
    focusTerms: ["變笨"],
    focusCue: "「變笨」——這個詞有辦法直接觀察或測量嗎？先判斷這個概念能不能轉成具體可研究的指標。",
    question: "滑手機會不會讓人變笨？",
  ...
  },
  {
    ...
    focusTerms: ["天生","比較會讀書"],
    focusCue: "要驗證「天生就比較會讀書」——先想：這需要什麼研究方法？高中生在兩週內有辦法做嗎？",
  ...
  },
  {
    ...
    focusTerms: ["現任總統"],
    focusCue: "研究對象是現任總統——先想最根本的問題：你有辦法安排這場訪談嗎？",
