...
export const PORTFOLIO_REGISTRY = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'w11-pilot-as-subject', label: '當受測者反思', question: '換你被測時——你以為對方在研究什麼？實際感受？工具最該優化的一點？' },
      { key: 'w11-pilot-self-check', label: 'Pilot 紀錄品質自檢', question: '勾完才能進工具修正——我寫的回饋是真的、我自己觀察到的問題用自己的話寫等 5 條' },
