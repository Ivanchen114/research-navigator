...
export const PORTFOLIO_REGISTRY = [
  ...
  },
  {
    ...
    weekRoute: '/w9',
    fields: [
        /* W9 主產出是計畫書 docx；網頁只匯出 AI 使用紀錄 + 勾選類欄位。
         * 已移除 w9-motivation-extended / w9-method-reason / w9-plan-ai-check
         * （這 3 個 ThinkRecord 已改提示卡，內容寫進 docx）。
         */
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'w13-table-structure', label: '我的分析表結構（必做）', question: '交前 4 項自查（欄位對應研究問題／對應操作型定義／標待確認／連結已貼）' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'w14-pre-judgment', label: '草圖判讀（驗收型必填）', question: '草圖判讀自評（選定變項／預期趨勢／一句話結論）' },
      ...
      { key: 'w14-validation-check', label: '圖表驗收結果', question: '3 鐵規勾選（標題在上／N 值有標／資料來源在下）' },
