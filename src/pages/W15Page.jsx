    ...
    return (
        <div className="page-container animate-in-fade-slide">
            ...
            {[
                {
                    id: 3,
                    title: '海報邏輯說明（第二節 0:00–0:10，10 分鐘）',
                    ol: ['老師說明「大少準亮」四法則（參考下方觀念六）', '對照好壞範例：圖太小、字太多的海報 vs. 符合法則的海報', '確認你的研究有一張「主圖」（最重要的圖表），它會佔版面最大空間', '在腦中預想：你的海報主圖是哪一張？'],
                    tip: '觀念六的版型只是參考——你的主圖放哪裡可以不同，但「有一個最大的主視覺」這個邏輯不變。'
                },
                {
                    id: 4,
                    title: '強制紙筆線框圖（第二節 0:10–0:25，15 分鐘）',
                ...
                {
                    id: 5,
                    title: '數位排版（第二節 0:25–0:40，15 分鐘）',
