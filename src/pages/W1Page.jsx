                        ...
                        <div className="flex flex-col gap-6 prose-zh">
                            ...
                            <StepBriefing
                                lines={mode === 'self-study' ? [
                                    ...
                                    { label: '學', text: '用 AI-RED 五字回顧你剛才跑的流程 + 確認這學期三件不能外包的事' },
                                    { label: '記', text: '寫下你注意到的：人做了哪些步驟、AI 做了什麼、哪裡讓你意外' },
                                ] : [
                                    { label: '看', text: '觀察老師示範：填表 → 貼提示詞 → 讀 AI 歸納 → 找 AI 落差' },
                                    { label: '學', text: 'AI-RED 五字如何對應剛才的示範 + 這學期三件不能外包的事' },
                                    { label: '記', text: '寫下你觀察到的：哪些是人做的、哪些是 AI 做的' },
                                ]}
                            />
