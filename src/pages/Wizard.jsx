...
import ThinkRecord, { readRecords } from '../components/ui/ThinkRecord';
                ...
                <div className="space-y-8 prose-zh">
                    ...
                    <div className="bg-[var(--ink)] text-white rounded-[var(--radius-unified)] p-6">
                        ...
                        <p className="text-[14px] text-white/85 leading-relaxed">
                            ...
                            第一步：把 W2 題目原封不動當病人搬過來，別急著改。第二步：用萬用心法診斷。第三步：用 5W1H 切開看清楚。
                    ...
                    {w2Intent ? (
                        <div className="border border-[var(--accent)]/30 bg-[var(--accent-light)]/20 rounded-[var(--radius-unified)] p-5">
                            <div className="text-[11px] font-mono text-[var(--accent)] uppercase tracking-wider mb-2">📎 你上週的 W2 最終探究意圖（這就是病人）</div>
                    ...
                    <div className="bg-white border border-[var(--border)] rounded-[var(--radius-unified)] overflow-hidden">
                        ...
                        <div className="p-5 space-y-4">
                            <ThinkRecord
                                ...
                                prompt="你的題目得了什麼病？用萬用心法怎麼改？"
                                scaffold={[
                                    '我的 W2 題目是：',
                                    '我覺得它得了 ___ 病，因為：',
                                    '我要用的心法是（大→小／空→實／遠→近／難→易，可複選）：',
                                    '初步想法：',
                                ]}
                                rows={6}
                            />
                ...
                <div className="space-y-8 prose-zh">
                    ...
                    <section className="bg-white border border-[var(--border)] rounded-[var(--radius-unified)] overflow-hidden">
                        ...
                        <div className="p-5">
                            <ThinkRecord
                                dataKey="w3-p5-draft"
                                prompt="把 Part 4 修改後的題目抄過來（或再精修一輪）"
                                placeholder="例：本校高一學生在段考前一週的夜間手機使用時數，與隔日上午第一節專注力自評之間的相關性。"
                                scaffold={['我的題目初稿：']}
                                rows={3}
                            />
                    ...
                    <section className="bg-white border border-[var(--border)] rounded-[var(--radius-unified)] overflow-hidden">
                        ...
                        <div className="p-5">
                            <AIAssistToggle
                                id="w3-p5-diagnose"
                                title="要用 AI 幫你診斷題目嗎？"
                                reason="只問診斷、不問改法。讓 AI 當第二雙眼睛，看你自己看不到的盲點。"
                                prompt={MY_DIAGNOSE_PROMPT}
                                recordKey="w3-p5-diagnose-ai-record"
                                recordPrompt="AI 給你的診斷是什麼？你覺得哪些準、哪些不準？"
                                recordPlaceholder="AI 說：___&#10;我覺得 ___ 準，因為 ___&#10;我覺得 ___ 不準，因為 ___"
                            />
                        </div>
                    </section>
