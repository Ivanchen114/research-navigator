        ...
        <div className="page-container animate-in-fade-slide">
            ...
            <div className="mt-5 p-4 rounded-[var(--radius-unified)] border-l-4 border-[#7C3AED] bg-[#F5F3FF]">
                ...
                <ThinkRecord
                    ...
                    placeholder={'例：\n本週遇到：訪談對象 5 位中有 2 位放鴿子，剩 3 位\n調整為：啟動備用受訪者，再約到 1 位（共 4 位），且不再勉強第 5 位\n（這個調整有沒有改變研究問題？）研究問題不變，但要在第三章加一段「樣本條件改變」的說明，並在第八章批判層誠實寫出來'}
                    scaffold={['本週遇到：…', '調整為：…', '（這個調整有沒有改變研究問題？）…']}
                />
            </div>
