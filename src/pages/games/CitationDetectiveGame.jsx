                ...
                <div className="bg-slate-900/70 p-8 md:p-12 rounded-sm shadow-[0_0_40px_rgba(0,0,0,0.5)] max-w-xl w-full text-center border-t-[8px] border-amber-500 relative overflow-hidden z-10  border border-white/10 group hover:border-amber-500/30 transition-colors duration-500">
                    ...
                    <div className="bg-amber-950/40 border border-amber-500/30 rounded-sm p-5 mb-6 text-left">
                        ...
                        <div className="space-y-1.5 text-xs">
                            <div className="flex items-center gap-2"><span className="text-yellow-300 font-black w-14">95%↑</span><span className="text-amber-100 font-bold w-20">王牌偵探</span><span className="text-slate-400">引用零誤</span></div>
                            <div className="flex items-center gap-2"><span className="text-cyan-300 font-black w-14">80%↑</span><span className="text-amber-100 font-bold w-20">一級偵探</span><span className="text-slate-400">線索清晰</span></div>
                            <div className="flex items-center gap-2"><span className="text-emerald-300 font-black w-14">60%↑</span><span className="text-amber-100 font-bold w-20">見習偵探</span><span className="text-slate-400">過關，記入軍階</span></div>
                            <div className="flex items-center gap-2"><span className="text-rose-300 font-black w-14">&lt;60%</span><span className="text-amber-100 font-bold w-20">線民實習生</span><span className="text-slate-400">建議再訓練</span></div>
                        </div>
