...
const W14Page = () => {
    ...
    const steps = [
        {
            ...
            content: (
                <div className="flex flex-col gap-6">
                    <CourseArc current={15} totalWeeks={17} title="W15 四層結論" subtitle="從圖的說明到研究結論" />
    ...
    return (
        <StepEngine weekTitle="W15 四層結論" weekSubtitle="從圖的說明到研究結論" steps={steps} prevWeek="/w14" nextWeek="/w16" />
    );
};
