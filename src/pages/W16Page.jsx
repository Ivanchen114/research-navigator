...
const W16Page = () => {
    ...
    return (
        <div className="page-container" style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px' }}>
            ...
            <div style={{ marginBottom: 24 }}>
                ...
                <h1 style={{ fontSize: 22, fontWeight: 800, color: 'var(--ink)', margin: 0, lineHeight: 1.3 }}>
                    最終發表：Gallery Walk 策展
                </h1>
                <p style={{ fontSize: 13, color: 'var(--ink-mid)', marginTop: 8, lineHeight: 1.7 }}>
                    今天每個人都是知識的生產者，也是知識的接收者。紙本學習單發表時填寫，這頁只是行前說明。
                </p>
            </div>

            <CourseArc current={17} />
