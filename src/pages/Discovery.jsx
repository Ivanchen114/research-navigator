    ...
    return (
        <div className="page-container animate-in-fade-slide">
            ...
            <div className="meta-strip" style={{ '--cols': 3 }}>
                {[
                    { label: '本週任務', value: '偵探試煉 · Level 0' },
                    { label: '課堂產出', value: '三把劍筆記' },
                    { label: '下週預告', value: 'W1 模仿遊戲 + AI-RED' }
                ].map((item, idx) => (
            ...
            <div className="section-head">
                ...
                <span className="mono uppercase">Concept</span>
            </div>
            ...
            <div className="section-head">
                <h2>練什麼</h2>
                <div className="line"></div>
                <span className="mono uppercase">Practice</span>
            </div>
            ...
            <div className="section-head">
                <h2>課堂任務</h2>
                <div className="line"></div>
                <span className="mono uppercase">In-Class</span>
            </div>
            ...
            <div className="section-head">
                <h2>本週總結</h2>
                <div className="line"></div>
                <span className="mono uppercase">Week Wrap-up</span>
            </div>
