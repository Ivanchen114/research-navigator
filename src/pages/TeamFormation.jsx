...
const EXPORT_FIELDS = [
    ...
    { key: 'w8-group-rationale', label: '路線理由', question: '為什麼選這條路線？（研究層面的理由）' },
    /* Part B */
                ...
                <div className="space-y-8 prose-zh">
                    ...
                    <div className="border-t border-dashed border-[var(--border)] pt-6 mt-2">
                        ...
                        <ThinkRecord
                            ...
                            prompt="為什麼你選這條路線？（下面會選合題或單飛，先用研究語言寫理由）"
                            placeholder="用研究語言，不是社交語言——「因為我們很熟」「因為沒人跟我」都不算理由。&#10;&#10;▸ 如果要合題：寫你和隊友題目的研究交集、能力互補、可協作條件。&#10;  例：我們都想研究「睡眠品質 × 學業表現」，我負責問卷設計，他有數據分析能力，同班能一起發問卷。&#10;&#10;▸ 如果要單飛：寫這題為什麼適合一個人做、你的獨立資源、Solo 的研究優勢。&#10;  例：這題訪談對象我都認識，只需要 5 人樣本，單飛反而避免組員方向不一致拖慢進度。"
                            rows={6}
                        />
                    </div>
            ...
            content: route === 'solo' ? (
                ...
                <div className="space-y-6 prose-zh">
                    ...
                    <ThinkRecord
                        ...
                        prompt="② 單飛自評：具體資源盤點？風險？Plan B？求援計畫？"
                        scaffold={[
                            'Step 1 — 具體資源盤點：我有的【能力】（例：會用 Google 表單） / 【資源】（例：訪談對象在身邊） / 【時間】（例：每週兩小時可投入）——',
    ...
    return (
        <div className="page-container animate-in-fade-slide">
            ...
            <HeroBlock
                ...
                chain="方法選完了。下週要動手寫計畫書——這週先把題目最後收斂、組好隊、把關鍵想法寫成草稿。"
                meta={[
