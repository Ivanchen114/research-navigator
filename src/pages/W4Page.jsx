        ...
        <div className="page-container animate-in-fade-slide">
            ...
            <div className="border border-[#dddbd5] rounded-xl overflow-hidden bg-white mb-16 shadow-sm">
                ...
                <div className="p-8 md:p-12">
                    <div className="flex flex-col gap-10 lg:gap-14 max-w-4xl mx-auto w-full">
                        {/* Visual Column */}
                        <div className="w-full">
                            <div className="text-[11px] font-mono text-[#8888aa] mb-4 uppercase tracking-widest font-bold">視覺海報 (橫式內容)</div>
                            <div className="border border-[#dddbd5] rounded-xl overflow-hidden shadow-xl shadow-black/5 aspect-[4/3] lg:aspect-[1.414/1] bg-[#f8f7f4] flex items-center justify-center group relative w-full">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 w-full">
                                <div className="p-5 bg-[#f8f7f4] rounded-lg border-l-4 border-[#2d5be3] flex flex-col h-full">
                                    ...
                                    <p className="text-[13px] text-[#4a4a6a] italic mt-auto">正式研究題目：高中生睡前手機使用時數與課堂專注度之相關性探討</p>
                                </div>
                                <div className="p-5 bg-[#f8f7f4] rounded-lg border-l-4 border-[#c9a84c] flex flex-col h-full">
                                    <div className="text-[11px] font-mono text-[#8888aa] mb-4 uppercase">研究假設 (AI 優化後)</div>
                                    <ol className="space-y-4 list-decimal pl-4">
                                        <li className="text-[13px] text-[#4a4a6a] leading-relaxed">
                                            <span className="font-bold block mb-1">假設一</span>
                                            睡前使用手機超過 1 小時的同學，其大腦灰質活動可能持續處於興奮狀態，導致隔天專注度明顯下降。
                                        </li>
                                        <li className="text-[13px] text-[#4a4a6a] leading-relaxed">
                                            <span className="font-bold block mb-1">假設二</span>
                                            參與社群媒體互動（如 IG/TikTok）的視覺與心理刺激，可能比單純觀看影片更容易延後褪黑激素的分泌。
                                        </li>
                                    </ol>
                                </div>
                            </div>
                            <div className="notice notice-gold !mt-auto text-[12px] w-full">
                    ...
                    <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div className="flex flex-col">
                                <label className="block text-[11px] font-mono text-[#8888aa] mb-2 uppercase">研究假設草稿</label>
                                <textarea
