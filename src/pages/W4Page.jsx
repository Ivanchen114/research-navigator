...
const DECISION_TREE = {
    l1: {
        question: 'L1 第一層　你的資料，要自己去收集，還是分析現成的文本？',
        options: [
            {
                id: 'collect',
                icon: '🔍',
...
const QUIZ_QUESTIONS = [
    ...
    {
        q: '「我想分析過去十年高中校刊對『升學壓力』議題的描寫角度變化」→ 適合哪種方法？',
        options: [
            { label: 'A', text: '實驗' },
            { label: 'B', text: '問卷' },
            { label: 'C', text: '文獻分析' },
        ...
        answer: 'C',
        hint: '把校刊文本當研究對象、分析其描寫模式 → 文獻分析法（內容分析子類）。注意：這是「分析文本」，不是「整理前人研究發現」（後者是文獻回顧）。'
    },
    {
        q: '下列哪個題目「最不適合」用問卷？',
        options: [
    ...
    },
    {
        ...
        answer: 'C',
        hint: '分析已有媒體文本中詞彙/主題的模式 → 文獻分析法（內容分析子類）'
    },
    {
