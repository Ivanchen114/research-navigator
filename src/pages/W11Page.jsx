...
const W11Page = () => {
    ...
    return (
        <div className="mx-auto" style={{ maxWidth: 720, padding: '24px 16px 80px' }}>
            ...
            {/* ─── 頁首 ─── */}
            <CourseArc current={12} totalWeeks={17} title="W12 執行週 I" subtitle="研究診所 Open Office" />
            ...
            <div className="mt-6 p-5 rounded-[var(--radius-unified)] border border-[var(--border)] bg-[var(--paper-warm)]">
                ...
                <p className="text-[13px] text-[var(--ink-mid)] leading-relaxed">
                    這堂課沒有老師台上講課。整堂課是<strong>自由工作時間 + 個別診所</strong>。
                    你的核心任務只有一個：<strong>把資料蒐集回來。</strong>
                    <br />這個頁面是你的工具箱——遇到問題就來翻，不用填寫。最後 10 分鐘再寫研究日誌。
                </p>
            </div>
