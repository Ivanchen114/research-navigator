            ...
            content: (
                <div className="space-y-8 prose-zh">
                    ...
                    <ThinkRecord
                        ...
                        defaultTemplate="我們最大的改變是___，因為 AI 建議／預試時發現___"
            ...
            content: (
                <div className="space-y-8 prose-zh">
                    ...
                    <ThinkRecord
                        ...
                        defaultTemplate={'資料儲存方式：□ 僅本人可看的雲端  □ 組員共用文件  □ 紙本\n誰可以接觸：□ 只有研究者  □ 加上指導老師\n何時刪除：□ 報告繳交後  □ 本學年結束後'}
                        rows={3}
                    />
            ...
            content: (
                <div className="space-y-8 prose-zh">
                    ...
                    <ThinkRecord
                        ...
                        defaultTemplate={'理想目標：___份問卷 / ___位受訪者 / ___次觀察 / ___篇文獻\n最低底線：___份 / ___位（萬一回收率低的保底數字）'}
                    ...
                    <ThinkRecord
                        ...
                        defaultTemplate={'W12 第一天：___（負責人：___）\nW12 第二天：___\nW12 第三天：___\nW13 第一天：___\nW13 最後一天：所有資料收齊！'}
                    ...
                    <ThinkRecord
                        ...
                        defaultTemplate={'困難 1：回收率不足 → 備案：由___在___（時間）去___（地點）做___\n困難 2：受訪者取消 → 備案：___\n困難 3：___'}
