 ...
 *
 * 教學邏輯：W2 完整五欄表格、W4 單欄打底之後，學生應該能把 AI-RED 寫成一段
...
const DEFAULT_SCAFFOLD = [
    ...
    'R 我查證了___（查原始資料／找可靠來源／問老師或同學／必要時再追問 AI）',
...
我去查證——用 Google 搜尋「高中生手機使用時數 研究」，找到兩篇文獻確實有類似數字。我採納了 Gemini 把「手機使用」改成「每日使用時數」的建議，但沒引用它說的那個數據，因為我要用自己查到、來源清楚的文獻。
    ...
    return (
        <div className="rounded-[8px] border border-[var(--accent)]/25 bg-[var(--accent-light)]/40 p-4 md:p-5">
            ...
            <p className="text-[13px] text-[var(--ink-mid)] leading-[1.75] mb-3">
                五欄表格是練習版，現在用<strong className="text-[var(--ink)]">一段話</strong>把最重要的一次 AI 互動寫下來。{optional ? '就算課堂沒規定用 AI，只要你自主用過——就值得記錄。' : ''}重點不是填滿五欄，而是讓 A-I-R-E-D 變成你自然的思考節奏。
            </p>
